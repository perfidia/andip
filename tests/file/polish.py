...
class FilePolishTest(unittest.TestCase):
    ...
    def testGetWordVerb(self):
        ...
        self.assertEqual('występuje', self.ad.get_word(('czasownik', 'występować', {'aspekt': 'dokonane', 'forma': 'czas teraźniejszy', 'liczba': 'pojedyncza', 'osoba': 'pierwsza'})))
        self.assertEqual('występują', self.ad.get_word(('czasownik', 'występować', {'aspekt': 'dokonane', 'forma': 'czas teraźniejszy', 'liczba': 'mnoga', 'osoba': 'trzecia'})))

        self.assertEqual('jest', self.ad.get_word(('czasownik', 'być', {'aspekt': 'dokonane', 'forma': 'czas teraźniejszy', 'liczba': 'pojedyncza', 'osoba': 'trzecia'})))
        self.assertEqual('są',   self.ad.get_word(('czasownik', 'być', {'aspekt': 'dokonane', 'forma': 'czas teraźniejszy', 'liczba': 'mnoga', 'osoba': 'trzecia'})))
